...
impl DynamicContractImpl {
    ...
    pub(crate) fn deploy_erc20_token(&self) -> Result<Address, ContractError> {
    ...
    pub(crate) fn ft_transfer_call(
        ...
        *unsafe { Box::from_raw((self.ft_transfer_call_fn)().cast()) }
    }

    #[cfg(not(feature = "ext-connector"))]
    pub(crate) fn ft_resolve_transfer(&self) -> Result<(), ContractError> {
        *unsafe { Box::from_raw((self.ft_resolve_transfer_fn)().cast()) }
    }

    #[cfg(not(feature = "ext-connector"))]
    pub(crate) fn ft_transfer(&self) -> Result<(), ContractError> {
        *unsafe { Box::from_raw((self.ft_transfer_fn)().cast()) }
    }

    #[cfg(not(feature = "ext-connector"))]
    pub(crate) fn withdraw(&self) -> Result<(), ContractError> {
        *unsafe { Box::from_raw((self.withdraw_fn)().cast()) }
    }

    #[cfg(not(feature = "ext-connector"))]
    pub(crate) fn deposit(&self) -> Result<Option<PromiseWithCallbackArgs>, ContractError> {
        *unsafe { Box::from_raw((self.deposit_fn)().cast()) }
    }

    #[cfg(not(feature = "ext-connector"))]
    pub(crate) fn finish_deposit(&self) -> Result<Option<PromiseWithCallbackArgs>, ContractError> {
        *unsafe { Box::from_raw((self.finish_deposit_fn)().cast()) }
    }

    #[cfg(not(feature = "ext-connector"))]
    pub(crate) fn storage_deposit(&self) -> Result<(), ContractError> {
        *unsafe { Box::from_raw((self.storage_deposit_fn)().cast()) }
    }

    #[cfg(not(feature = "ext-connector"))]
    pub(crate) fn storage_unregister(&self) -> Result<(), ContractError> {
        *unsafe { Box::from_raw((self.storage_unregister_fn)().cast()) }
    }

    #[cfg(not(feature = "ext-connector"))]
    pub(crate) fn storage_withdraw(&self) -> Result<(), ContractError> {
        *unsafe { Box::from_raw((self.storage_withdraw_fn)().cast()) }
    }

    #[cfg(not(feature = "ext-connector"))]
    pub(crate) fn set_paused_flags(&self) -> Result<(), ContractError> {
        *unsafe { Box::from_raw((self.set_paused_flags_fn)().cast()) }
    }
    ...
    #[cfg(not(feature = "ext-connector"))]
    pub(crate) fn set_eth_connector_contract_data(&self) -> Result<(), ContractError> {
        *unsafe { Box::from_raw((self.set_eth_connector_contract_data_fn)().cast()) }
    }

    #[cfg(not(feature = "ext-connector"))]
    pub(crate) fn new_eth_connector(&self) -> Result<(), ContractError> {
        *unsafe { Box::from_raw((self.new_eth_connector_fn)().cast()) }
    }
