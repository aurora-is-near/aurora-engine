...
impl AsRef<[u8]> for TransactionStatus {
    fn as_ref(&self) -> &[u8] {
        match self {
            ...
            Self::PriorityFeeGreaterThanMaxFee => b"PriorityFeeGreaterThanMaxFee",
            Self::GasPriceLessThanBasefee => b"GasPriceLessThanBasefee",
            Self::CallerGasLimitMoreThanBlock => b"CallerGasLimitMoreThanBlock",
            Self::CallGasCostMoreThanGasLimit => b"CallGasCostMoreThanGasLimit",
            Self::RejectCallerWithCode => b"RejectCallerWithCode",
            Self::LackOfFundForMaxFee => b"LackOfFundForMaxFee",
            Self::OverflowPaymentInTransaction => b"OverflowPaymentInTransaction",
            Self::NonceOverflowInTransaction => b"NonceOverflowInTransaction",
            Self::NonceTooHigh => b"NonceTooHigh",
            Self::NonceTooLow => b"NonceTooLow",
            Self::CreateInitCodeSizeLimit => b"CreateInitCodeSizeLimit",
            Self::InvalidChainId => b"InvalidChainId",
            Self::AccessListNotSupported => b"AccessListNotSupported",
            Self::MaxFeePerBlobGasNotSupported => b"MaxFeePerBlobGasNotSupported",
            Self::BlobVersionedHashesNotSupported => b"BlobVersionedHashesNotSupported",
            Self::BlobGasPriceGreaterThanMax => b"BlobGasPriceGreaterThanMax",
            Self::EmptyBlobs => b"EmptyBlobs",
            Self::BlobCreateTransaction => b"BlobCreateTransaction",
            Self::TooManyBlobs => b"TooManyBlobs",
            Self::BlobVersionNotSupported => b"BlobVersionNotSupported",
            Self::PrevrandaoNotSet => b"PrevrandaoNotSet",
            Self::ExcessBlobGasNotSet => b"ExcessBlobGasNotSet",
        }
    }
}
