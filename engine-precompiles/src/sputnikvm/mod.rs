...
impl From<Log> for crate::types::Log {
...
impl From<ExitError> for crate::types::ExitError {
...
impl From<ExitFatal> for crate::types::ExitFatal {
...
mod tests {
    ...
    fn test_precompile_addresses() {
        ...
        assert_eq!(
            super::Bn256Mul::<crate::Istanbul>::ADDRESS,
            u8_to_address(7)
        );
        assert_eq!(
            super::Bn256Pair::<crate::Istanbul>::ADDRESS,
            u8_to_address(8)
        );
        assert_eq!(crate::blake2::Blake2F::ADDRESS, u8_to_address(9));
    }
    ...
    fn test_paused_precompiles_throws_error() {
        ...
        impl Precompile for MockPrecompile {
            ...
            fn run(
                ...
                Ok(crate::PrecompileOutput::default())
            }
        }
        ...
        let precompile: crate::AllPrecompiles<StoragePointer, Fixed, Noop> =
            crate::AllPrecompiles::Generic(Box::new(MockPrecompile));

        let precompiles: crate::Precompiles<StoragePointer, Fixed, Noop> = crate::Precompiles {
            all_precompiles: {
