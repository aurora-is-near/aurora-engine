...
use aurora_engine::{
    ...
    engine::{self, Engine},
    errors,
    parameters::{GetErc20FromNep141CallArgs, GetStorageAtArgs, ViewCallArgs},
    state,
};
...
///
#[no_mangle]
pub extern "C" fn _native_new_eth_connector() -> *mut ffi::c_void {
    let io = Runtime;
    let env = Runtime;
    let result = contract_methods::connector::new_eth_connector(io, &env);
    Box::into_raw(Box::new(result)).cast()
}

#[no_mangle]
pub extern "C" fn _native_set_eth_connector_contract_data() -> *mut ffi::c_void {
    let io = Runtime;
    let env = Runtime;
    let result = contract_methods::connector::set_eth_connector_contract_data(io, &env);
    Box::into_raw(Box::new(result)).cast()
}
...
#[no_mangle]
pub extern "C" fn _native_deposit() -> *mut ffi::c_void {
    let io = Runtime;
    let env = Runtime;
    let mut handler = Runtime;
    let result = contract_methods::connector::deposit(io, &env, &mut handler);
    Box::into_raw(Box::new(result)).cast()
}

#[no_mangle]
pub extern "C" fn _native_finish_deposit() -> *mut ffi::c_void {
    let io = Runtime;
    let env = Runtime;
    let mut handler = Runtime;
    let result = contract_methods::connector::finish_deposit(io, &env, &mut handler);
    Box::into_raw(Box::new(result)).cast()
}

/// Get bridge prover id for this contract.
#[no_mangle]
pub extern "C" fn _native_get_bridge_prover() -> *mut ffi::c_void {
    let io = Runtime;
    let result = contract_methods::connector::get_bridge_prover(io);
    Box::into_raw(Box::new(result)).cast()
}

#[no_mangle]
pub extern "C" fn _native_is_used_proof() -> *mut ffi::c_void {
    let io = Runtime;
    let result = contract_methods::connector::is_used_proof(io);
    Box::into_raw(Box::new(result)).cast()
}
...
#[no_mangle]
pub extern "C" fn _native_ft_total_eth_supply_on_aurora() -> *mut ffi::c_void {
    let io = Runtime;
    let result = contract_methods::connector::ft_total_eth_supply_on_aurora(io);
    Box::into_raw(Box::new(result)).cast()
}
...
#[no_mangle]
pub extern "C" fn _native_ft_balances_of() -> *mut ffi::c_void {
    let io = Runtime;
    let result = contract_methods::connector::ft_balances_of(io);
    Box::into_raw(Box::new(result)).cast()
}
...
#[no_mangle]
pub extern "C" fn _native_ft_transfer() -> *mut ffi::c_void {
    let io = Runtime;
    let env = Runtime;
    let result = contract_methods::connector::ft_transfer(io, &env);
    Box::into_raw(Box::new(result)).cast()
}

#[no_mangle]
pub extern "C" fn _native_ft_resolve_transfer() -> *mut ffi::c_void {
    let io = Runtime;
    let env = Runtime;
    let handler = Runtime;
    let result = contract_methods::connector::ft_resolve_transfer(io, &env, &handler);
    Box::into_raw(Box::new(result)).cast()
}

#[no_mangle]
pub extern "C" fn _native_ft_transfer_call() -> *mut ffi::c_void {
    let io = Runtime;
    let env = Runtime;
    let mut handler = Runtime;
    let result = contract_methods::connector::ft_transfer_call(io, &env, &mut handler);
    Box::into_raw(Box::new(result)).cast()
}
...
#[no_mangle]
pub extern "C" fn _native_storage_deposit() -> *mut ffi::c_void {
    let io = Runtime;
    let env = Runtime;
    let mut handler = Runtime;
    let result = contract_methods::connector::storage_deposit(io, &env, &mut handler);
    Box::into_raw(Box::new(result)).cast()
}

#[no_mangle]
pub extern "C" fn _native_storage_unregister() -> *mut ffi::c_void {
    let io = Runtime;
    let env = Runtime;
    let mut handler = Runtime;
    let result = contract_methods::connector::storage_unregister(io, &env, &mut handler);
    Box::into_raw(Box::new(result)).cast()
}

#[no_mangle]
pub extern "C" fn _native_storage_withdraw() -> *mut ffi::c_void {
    let io = Runtime;
    let env = Runtime;
    let result = contract_methods::connector::storage_withdraw(io, &env);
    Box::into_raw(Box::new(result)).cast()
}
...
#[no_mangle]
pub extern "C" fn _native_get_paused_flags() -> *mut ffi::c_void {
    let io = Runtime;
    let result = contract_methods::connector::get_paused_flags(io);
    Box::into_raw(Box::new(result)).cast()
}

#[no_mangle]
pub extern "C" fn _native_set_paused_flags() -> *mut ffi::c_void {
    let io = Runtime;
    let env = Runtime;
    let result = contract_methods::connector::set_paused_flags(io, &env);
    Box::into_raw(Box::new(result)).cast()
}

#[no_mangle]
pub extern "C" fn _native_get_accounts_counter() -> *mut ffi::c_void {
    let io = Runtime;
    let result = contract_methods::connector::get_accounts_counter(io);
    Box::into_raw(Box::new(result)).cast()
}
...
pub extern "C" fn _native_get_erc20_from_nep141() -> *mut ffi::c_void {
    let f = move || -> Result<(), ContractError> {
        let mut io = Runtime;
        let args: GetErc20FromNep141CallArgs = io.read_input_borsh()?;
        let result = engine::get_erc20_from_nep141(&io, &args.nep141)?;
...
pub extern "C" fn _native_ft_metadata() -> *mut ffi::c_void {
    let io = Runtime;
    let result = contract_methods::connector::ft_metadata(io);
    Box::into_raw(Box::new(result)).cast()
}
