...
fn test_data_test_first_zero_bytes() -> Result<(), std::io::Error> {
    let data_test_first_zero_bytes = TransactionTest::new("TransactionTests/ttData/DataTestFirstZeroBytes.json".to_string(), "DataTestFirstZeroBytes".to_string());
...
fn test_data_test_last_zero_bytes() -> Result<(), std::io::Error> {
    let data_test_last_zero_bytes = TransactionTest::new("TransactionTests/ttData/DataTestLastZeroBytes.json".to_string(), "DataTestLastZeroBytes".to_string());
...
fn test_data_test_not_enough_gas() -> Result<(), std::io::Error> {
    let data_test_not_enough_gas = TransactionTest::new("TransactionTests/ttData/DataTestNotEnoughGAS.json".to_string(), "DataTestNotEnoughGAS".to_string());
...
fn test_data_test_zero_bytes() -> Result<(), std::io::Error> {
    let data_test_zero_bytes = TransactionTest::new("TransactionTests/ttData/DataTestZeroBytes.json".to_string(), "DataTestZeroBytes".to_string());
...
fn test_dataTx_bcValidBlockTest() -> Result<(), std::io::Error> {
    let data_tx_bc_valid_block_test = TransactionTest::new("TransactionTests/ttData/dataTx_bcValidBlockTest.json".to_string(), "dataTx_bcValidBlockTest".to_string());
...
fn test_dataTx_bcValidBlockTestFrontier() -> Result<(), std::io::Error> {
    let data_tx_bc_valid_block_test_frontier = TransactionTest::new("TransactionTests/ttData/dataTx_bcValidBlockTestFrontier.json".to_string(), "dataTx_bcValidBlockTestFrontier".to_string());
