...
unsafe extern "C" {
    ...
    pub(crate) fn bls12381_p1_sum(value_len: u64, value_ptr: u64, register_id: u64) -> u64;
    pub(crate) fn bls12381_p2_sum(value_len: u64, value_ptr: u64, register_id: u64) -> u64;
    pub(crate) fn bls12381_g1_multiexp(value_len: u64, value_ptr: u64, register_id: u64) -> u64;
    pub(crate) fn bls12381_g2_multiexp(value_len: u64, value_ptr: u64, register_id: u64) -> u64;
    pub(crate) fn bls12381_map_fp_to_g1(value_len: u64, value_ptr: u64, register_id: u64) -> u64;
    pub(crate) fn bls12381_map_fp2_to_g2(value_len: u64, value_ptr: u64, register_id: u64) -> u64;
    pub(crate) fn bls12381_pairing_check(value_len: u64, value_ptr: u64) -> u64;
    // #####################
    // # Miscellaneous API #
    // #####################
    ...
    // ###############
    // # Yield / Resume API, NEP-519 https://github.com/near/NEPs/blob/master/neps/nep-0519.md
    // ###############
