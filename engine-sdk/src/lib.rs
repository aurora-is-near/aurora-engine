...
#[cfg(feature = "contract")]
#[must_use]
pub fn bls12381_p2_sum(input: &[u8]) -> H256 {
    unsafe {
        const REGISTER_ID: u64 = 1;
...
#[cfg(feature = "contract")]
#[must_use]
pub fn bls12381_g1_multiexp(input: &[u8]) -> H256 {
    unsafe {
        const REGISTER_ID: u64 = 1;
...
#[cfg(feature = "contract")]
#[must_use]
pub fn bls12381_g2_multiexp(input: &[u8]) -> H256 {
    unsafe {
        const REGISTER_ID: u64 = 1;
...
#[cfg(feature = "contract")]
#[must_use]
pub fn bls12381_map_fp_to_g1(input: &[u8]) -> H256 {
    unsafe {
        const REGISTER_ID: u64 = 1;
...
#[cfg(feature = "contract")]
#[must_use]
pub fn bls12381_map_fp2_to_g2(input: &[u8]) -> H256 {
    unsafe {
        const REGISTER_ID: u64 = 1;
