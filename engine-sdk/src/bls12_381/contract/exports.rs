...
pub fn bls12381_g1_multiexp(input: &[u8]) -> Result<[u8; 96], u64> {
    unsafe {
        const REGISTER_ID: u64 = 1;
        let error_code =
...
pub fn bls12381_g2_multiexp(input: &[u8]) -> Result<[u8; 192], u64> {
    unsafe {
        const REGISTER_ID: u64 = 1;
        let error_code =
...
pub fn bls12381_map_fp_to_g1(input: &[u8]) -> Result<[u8; 96], u64> {
    unsafe {
        const REGISTER_ID: u64 = 1;
        let error_code =
...
pub fn bls12381_map_fp2_to_g2(input: &[u8]) -> Result<[u8; 192], u64> {
    unsafe {
        const REGISTER_ID: u64 = 1;
        let error_code =
